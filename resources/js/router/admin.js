...
import EditGeneralSetting from '../backEnd/setting/generalSetting/EditGeneralSetting.vue';
...
export default [
    {
        ...
        children: [
            ...
            { path: 'general/setting/:id', name: 'EditGeneralSetting', component: EditGeneralSetting },
        ],
    },
