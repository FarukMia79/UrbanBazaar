...
<div class="container-fluid mt-4 px-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h5 class="mb-0 fw-bold">Completed Order ({{ filterSearch.length }})</h5>
                            ...
                            <td>
                                <div class="d-flex invoice-box">
                                    ...
                                    <div class="w-50 ps-3">
                                        ...
                                        <p><label>Status:</label> <span class="badge btn-green text-capitalize" >{{ item.order.status }}</span></p>
                                    </div>
                                </div>
                            </td>
                            <td>
...
export default {
    ...
    computed: {
        filterSearch() {
            let completedOrders = this.orderItem.filter(item => {
            ...
            return this.completedOrders.filter(orderItem => {
