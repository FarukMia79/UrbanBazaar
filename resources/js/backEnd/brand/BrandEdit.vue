<template>
    <div class="container-fluid mt-4 px-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="fw-bold text-dark mb-0">Brand Create</h4>
            <router-link
                :to="{ name: 'BrandManage' }"
                class="btn btn-pink rounded-pill px-3 shadow-sm text-white"
                ><i class="fa-solid fa-tags me-1"></i>Brand
                Manage</router-link
            >
        </div>

        <div class="card border-0 shadow-custom rounded-4 p-4">
            <form @submit.prevent="updateBrandData" enctype="multipart/form-data">
                <div class="row g-4">
                    <!-- Name Field -->
                    <div class="col-12">
...
export default {
    ...
    methods: {
        ...
        updateBrandData(){
            ...
            axios.post(`/api/brand/${this.id}`, data)
            .then(()=>{
