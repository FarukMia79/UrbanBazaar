<template>
    <div class="container-fluid mt-4 px-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="fw-bold text-dark mb-0">Childcategory Create</h4>
            <router-link
                :to="{ name: 'ChildcategoryManage' }"
                class="btn btn-pink rounded-pill px-3 shadow-sm text-white"
                ><i class="fa-solid fa-database me-1"></i>Childcategory
                Manage</router-link
            >
        </div>
