<template>
    <div class="container-fluid mt-4 px-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="fw-bold text-dark mb-0">Update Banner Category</h4>
        ...
        <div class="card border-0 shadow-custom rounded-4 p-4">
            <form @submit.prevent="updateBranner" enctype="multipart/form-data">
                <div class="row g-4">
                    <!-- Name Field -->
                    <div class="col-6">
                        <label class="form-label fw-semibold text-muted">Banner Name *</label>
...
export default {
    ...
    methods: {
        ...
        updateBranner() {
            ...
            axios.post(`/api/banner-update/${this.id}`, data)
                .then((res) => {
