<template>
    <div class="container-fluid mt-4 px-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="fw-bold text-dark mb-0">Update Banner</h4>
        ...
        <div class="card border-0 shadow-custom rounded-4 p-4">
            <form @submit.prevent="updateBannerData" enctype="multipart/form-data">
                <div class="row g-4">
                    <!-- Name Field -->
                    <div class="col-6">
    ...
    methods: {
        getBanner() {
            axios.get(`/api/banner/${this.id}`)
                .then((res) => {
                    this.form.category_id = res.data.banner.category_id;
                    this.form.link = res.data.banner.link;
                    this.form.status = res.data.banner.status == 1;
                    this.imagePreview = '/' + res.data.banner.image;
                })
        },
        getBannerCategory() {
        ...
        updateBannerData() {
            ...
            axios.post(`/api/banner/${this.id}`, data)
                .then((res) => {
