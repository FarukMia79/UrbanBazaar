<template>
    <div class="container-fluid mt-4 px-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="fw-bold text-dark mb-0">Pixel Setting</h4>
            ...
            <div class="table-responsive">
                ...
                <thead>
                    <tr class="table-light text-muted">
                        ...
                        <th>Pixels ID <i class="fa-solid fa-sort ms-1 small opacity-50"></i></th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-muted">1296348748317817</td>
