            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-sm-10 col-md-6 col-lg-5">
                        <div class="form-content p-4 rounded-4 shadow-lg" style="
                                background: #ffffff;
                            ...
                            <div class="text-center mb-4">
                                ...
                                <h4 class="auth-title mt-3 mb-0 fw-semibold text-dark">
                                    Customer Login
                                </h4>
                            </div>
                            ...
                            <form @submit.prevent="LoginData">
                                ...
                                <div class="text-end mb-3">
                                    <router-link :to="{ name: 'ForgotPassword' }" class="text-decoration-none"
                                        style="color: #3f0051"><i class="fa-solid fa-unlock" style="color: #750377"></i>
